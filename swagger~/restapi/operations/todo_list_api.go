...
func NewTodoListAPI(spec *loads.Document) *TodoListAPI {
	return &TodoListAPI{
		...
		TodosGetSecretsHandler: todos.GetSecretsHandlerFunc(func(params todos.GetSecretsParams) middleware.Responder {
			return middleware.NotImplemented("operation todos.GetSecrets has not yet been implemented")
		}),
	}
}

/*TodoListAPI Identity and Access Management system swagger api document */
type TodoListAPI struct {
	...
	// TodosGetSecretsHandler sets the operation handler for the get secrets operation
	TodosGetSecretsHandler todos.GetSecretsHandler
...
func (o *TodoListAPI) Validate() error {
	...
	if o.TodosGetSecretsHandler == nil {
		unregistered = append(unregistered, "todos.GetSecretsHandler")
	}
...
func (o *TodoListAPI) initHandlerCache() {
	...
	o.handlers["GET"]["/secrets"] = todos.NewGetSecrets(o.context, o.TodosGetSecretsHandler)
}
